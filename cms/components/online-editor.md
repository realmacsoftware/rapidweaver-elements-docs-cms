...
{% hint style="warning" %}
The page hosting the Online Editor must use a `.php` extension and your server must meet the [System Requirements](../../getting-started/system-requirements.md) (PHP 8.1+, JavaScript enabled in the browser).
{% endhint %}
