...
| `402` | Payment Required | Site has no active license with JSON API access. | Activate a license with JSON API access, or see [Upgrading and Downgrading Plans](../upgrading-and-downgrading-plans.md). |
